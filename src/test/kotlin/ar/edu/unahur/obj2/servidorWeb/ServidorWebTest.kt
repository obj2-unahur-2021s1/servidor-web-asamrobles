...
//pedidos que pueden ser atendidos por algun modulo
    ...
    val pedidoTextoPDF = Pedido("125.333.345.1", "http://unahur.org.ar/documentos/texto1.pdf", LocalDateTime.of(2021,2,3,4,5,6))
    val pedidoAudioMP3 = Pedido("125.333.345.1", "http://unahur.org.ar/documentos/audio1.mp3", LocalDateTime.of(2020,1,2,3,4,5))
    val pedidoVideoMKV = Pedido("125.333.345.1", "http://unahur.org.ar/documentos/video1.mkv", LocalDateTime.of(2021,7,8,9,10,11))

//pedidos q no pueden ser atendidos por ningun modulo
    val pedidoComprimidoRAR = Pedido("125.333.345.1", "http://unahur.org.ar/documentos/docs.rar", LocalDateTime.of(2021,8,9,10,11,12))
    val pedidoImagenGIF = Pedido("125.333.345.1", "http://unahur.org.ar/documentos/gif1.gif", LocalDateTime.of(2021,9,10,11,12,13))

//pedidos con protocolo diferente a http
    val pedidoHTTPS = Pedido("125.333.345.2", "https://unahur.org.ar/documentos/doc2.html", LocalDateTime.of(2021,10,11,12,13,14))
    val pedidoFTP = Pedido("125.333.345.2", "ftp://unahur.org.ar/documentos/doc3.txt", LocalDateTime.of(2021,11,12,13,14,15))
